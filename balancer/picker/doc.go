...
// This is used by a [Balancer] to actual select a connection for use
// with a given request.
//
// This package defines the core interface, [Picker], as well as the
// interface used by a balancer to construct a [Picker]: [Factory].
//
...
// custom metadata ([Attributes]) for an address. But custom [Picker]
